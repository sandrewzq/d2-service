...
export const homeCopy: Record<InterfaceLocale, LocaleCopy["home"]> = {
    "zh-CN": {
      ...
      fallback: {
        ...
        accountReady: "已读取",
        accountPending: "待同步",
        weeklyFixedMeta: "本周固定关注位：先锋行动、本周轮换突袭、本周轮换地牢、仄商人",
      ...
      account: {
        failedTitle: "账号数据异常",
        readyTitle: "账号已就绪",
        pendingTitle: "装备数据待同步",
        syncing: "正在同步装备数据。",
        pendingMessage: "同步后显示角色、里程碑和仓库提醒。",
        failedBadge: "需处理",
        readyBadge: "正常",
        pendingBadge: "待同步",
        vaultTitle: "仓库容量",
    ...
    "en-US": {
      inline: {
        ...
        "日落、轮换、活动激涌": "Nightfall, rotations, and activity surges",
        "本周轮换突袭": "Weekly rotating raid",
        "本周轮换地牢": "Weekly rotating dungeon",
        "本周活动激涌": "Weekly activity surges",
        "暂无": "None",
        ...
        "本周活动激涌待确认": "Weekly activity surges pending",
        "登录 Bungie 后读取当前活动实际返回的元素激涌。": "Sign in to Bungie to read the elemental surges returned by current activities.",
        "仅对活动详情中列出对应修饰词的 PvE 内容生效；不作用于全部 PvE 或 PvP。": "Only applies to PvE activities that explicitly list the modifier; it is not active across all PvE or PvP.",
        ...
        "项已确认": "confirmed",
        "公开接口尚未确认": "Public API not confirmed",
        "当前不展示历史活动或推测内容。": "Historical or inferred activities are not shown.",
        "打开仄的完整库存": "Open Xur inventory",
        "当前位置": "Current location",
        "类型与职业备注未返回": "Type and class details unavailable",
        "当前轮换商品": "Current rotation item",
        "本周轮换": "Weekly rotation",
        "本周轮换暂不可用": "Weekly rotation unavailable",
        "本次读取失败，未显示过期库存。": "This read failed; stale inventory is hidden.",
        "正在读取本周八件轮换": "Loading this week's eight-item rotation",
        "等待公开商人数据和当前资料库返回。": "Waiting for public vendor data and the current library.",
        "当前没有可确认的仄本周八件轮换": "No confirmed Xur rotation this week",
        "商人未开放或本周轮换暂不可见。": "The vendor is unavailable or this week's rotation is not visible.",
        "资料库定义待补齐": "Library definitions pending",
        "件轮换商品暂无可读名称": "rotation items have no readable name",
        "Vendor API 已确认存在，不使用猜测名称、类型或图标。": "Vendor API confirmed the items; names, types, and icons are not guessed.",
      ...
      fallback: {
        ...
        weeklyFixedMeta: "Fixed weekly focus: Vanguard Ops, weekly rotating raid, weekly rotating dungeon, and Xur",
      ...
      account: {
        ...
        pendingTitle: "Gear data pending",
        syncing: "Syncing gear data.",
        pendingMessage: "After gear sync, show character, milestone, and vault reminders here.",
